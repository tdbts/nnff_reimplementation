	...
	getBodyContent: function () {
		return (
			<div id={this.props.panelName + "_panel_body_content"}>
				...
				<Blockquote quoteText={this.props.dateQuote} footerText="James B. Dale, MD, Chief, Division of Infectious Diseases University of Tennessee College of Medicine" />

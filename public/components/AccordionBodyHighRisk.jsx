	...
	render: function () {
		return (
			<div id="high_risk_content" className="panel_body_content">
				...
				<ul id="high_risk_content_list">
					<li>Chronically ill individuals &#8212; those with AIDS, cancer, coronary disease, chronic renal failure, and cirrhosis of the liver, among others.</li>
					<li>Children with chicken pox</li>
					<li>Diabetics</li>
					<li>People undergoing immunosupressive therapies</li>
					<li>Elderly individuals</li>
					<li>Obese individuals</li>
					<li>Women giving birth</li>

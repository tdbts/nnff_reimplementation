...
var WelcomeRow = React.createClass({
	...
	getTextColumnComponent: function (columnName) {
		...
		return <TextColumn attributeBase={columnData.attributeBase} glyphiconStr={columnData.glyphiconStr} columnTitle={columnData.columnTitle} columnText={columnData.columnText} />;
	},
